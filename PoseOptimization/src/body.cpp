...
Body::Body(const std::string &name, const std::experimental::filesystem::path &geometry_path,
...
void Body::set_T_n_pose(Transform3fA &T_n_pose)
{
	T_n_ = T_n_pose;
}
...
const Transform3fA &Body::T_n() const {
	//这里其实就是
	return T_n_;
}
