...
#ifndef OBJECT_TRACKING_INCLUDE_SRT3D_TEXTURE_RENDERER_H_
#define OBJECT_TRACKING_INCLUDE_SRT3D_TEXTURE_RENDERER_H_
...
namespace srt3d {
	...
	class teture_render : public Renderer {
	public:
		// Constructors, destructors, and setup method
		teture_render(const std::string &name,
