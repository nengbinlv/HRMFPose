...
class Body {
 public:
  ...
  Body(const std::string &name, const std::experimental::filesystem::path &geometry_path,
  ...
  void set_T_n_pose(Transform3fA &T_n_pose);
 ...
 public:
  ...
  Transform3fA T_n_{ Transform3fA::Identity() };   //АќЮЇКа
