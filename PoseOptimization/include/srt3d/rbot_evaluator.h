...
class RBOTEvaluator {
 private:
  static constexpr int kNFrames_ = 1000;  //1000  999  1419 1329 249 1398
  static constexpr srt3d::Intrinsics kRBOTIntrinsics{
	 650.048f, 647.183f, 324.328f - 0.5f, 257.323f - 0.5f, 640, 512 };
  //virtual 650.048f, 647.183f, 324.328f - 0.5f, 257.323f - 0.5f, 640, 512
  //real qel 1041.358060228542, 1041.837815116004, 308.2478381759722, 231.805250163066, 640, 480
  //real bcot 482.9516, 482.7811,321.5346, 253.04215 ,640, 512
 ...
 public:
  ...
  void SaveResults(std::experimental::filesystem::path save_directory);
 ...
 private:
  ...
  std::experimental::filesystem::path dataset_directory_;
