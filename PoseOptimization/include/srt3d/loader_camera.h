...
class LoaderCamera : public Camera {
 public:
  ...
  // Setters
  void set_load_directory(const std::experimental::filesystem::path &load_directory);
  ...
  // Getters
  const std::experimental::filesystem::path &load_directory() const;
 ...
 private:
  ...
  // Data
  std::experimental::filesystem::path load_directory_{};
