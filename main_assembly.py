...
from dataset.DatasetAssembly import MyDataset
from torch.utils.data import DataLoader
from evalAssembly import evaluator
...
writer = SummaryWriter('./runs-ours-data/' + f'/{datetime.datetime.now().strftime("%Y%m%d-%H%M%S")}/')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", type=str, default=os.path.join(os.getcwd(), r"data"))
    parser.add_argument("--class_type", type=str, default="part_02")
