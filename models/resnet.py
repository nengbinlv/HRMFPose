...
class ResNet(nn.Module):
    def __init__(
        ...
        # without edge
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False) #Translated comment.
...
class ResNet2(nn.Module):
    def __init__(
        ...
        # without edge
        self.conv1 = nn.Conv2d(64, 64, kernel_size=7, stride=2, padding=3, bias=False) #Translated comment.
        self.bn1 = nn.BatchNorm2d(64)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
